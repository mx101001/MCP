...
// Tool: leggi un file
server.tool("read_file", "Legge il contenuto di un file testuale", {
...
server.tool("list_directory", "Elenca i file in una directory", {
...
server.tool("file_info", "Restituisce metadati di un file o cartella", {
...
server.tool("read_file_range", "leggi un file partendo dalla linea x alla linea y", {
    file_path: z.string().describe("Percorso assoluto o relativo del file"),
